...
if __name__ == "__main__":
    ...
    general.add_argument("--input_train", default='/workspace/datasets/fasttext/train.data',  help="The directory containing training data")
    general.add_argument("--input_test", default='/workspace/datasets/fasttext/test.data',  help="The directory containing test data")
    general.add_argument("--output_params", default='/workspace/datasets/fasttext/params.file',  help="The directory containing training data")
    general.add_argument("--metric", default='precisionAtRecall:30',  help="metric objective")
    general.add_argument("--output_model", default="/workspace/datasets/fasttext/autotune_model", help="the file to output to")
